...
if choose == 0: 
    ...
    # Update the xy 
    the_spec.update_aXyInfo_for("q1",func='gauss',amp=0.046,len=40,LO=3.955-0.201-0.072,IF=-80+34.7+24.1+13.6-2.31,draga=0,delta=-200,AC=0,half=0.998)
    ...
    the_spec.export_spec("TESTspec_1201")
    myConfig.export_config("TESTconfig_1201")
