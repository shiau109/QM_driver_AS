...
from exp.rabi_SecondExcite import RabiTimeSecondExcite
from exp.plotting import plot_and_save_rabi

my_exp = RabiTimeSecondExcite(config, qmm)
...
my_exp.amp_resolution = 0.002

my_exp.freq_range = (-218-60,-218+60)
