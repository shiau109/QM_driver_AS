...
qop_ip = "192.168.1.94"  # Write the QM router IP address
qop_port = None 
...
# Set Octave
spec.update_octave( "octave1", ip=qop_ip, port=11252, con="con1", port_map=port_mapping, clock="External_1000MHz")
