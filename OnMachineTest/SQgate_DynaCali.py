...
if __name__ == '__main__':
    ...
    dyna_config.import_config(path=r'.\TEST\BETAsite\QM\OPXPlus\3_5q Tune up\Standard Configuration\Config_Alloffset_1207')
    ...
    the_specs.export_spec(path=r'.\TEST\BETAsite\QM\OPXPlus\3_5q Tune up\Standard Configuration\Spec_1207_Calied')
