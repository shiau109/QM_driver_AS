...
specs.update_WireInfo_for("q3",ro_mixer='octave_octave1_1',xy_mixer='octave_octave1_4',up_I=("con1", 1),up_Q=("con1", 2),down_I=("con1", 1),down_Q=("con1", 2),xy_I=("con1", 3),xy_Q=("con1", 4))
...
config.update_downconverter(channel=1,offset= 0.006487780227661133+0.00832853277297247, gain_db= 0)
config.update_downconverter(channel=2,offset= 0.004683707580566406+0.008599453735351563, gain_db= 0)
