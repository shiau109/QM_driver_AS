...
def DRAG_calibration( q_name, ro_element, config, qmm:QuantumMachinesManager, n_avg=100 ):
    ...
    if simulate:
        ...
        while results.is_processing():
            ...
            plt.subplot(313)
            plt.cla()
            plt.plot(amps * drag_coef, np.abs(state1-state2), label="x180y90")
...
if __name__ == '__main__':
    ...
    DRAG_calibration( "q4_xy", "rr4", config, qmm, n_avg)
    plt.show()