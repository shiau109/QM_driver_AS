...
def flux_dep_cavity( freq_IF_center:list, df_array, amp_ratio, cd_time, n_avg, config, ro_element, qmm:QuantumMachinesManager ):
        ...
        with for_(n, 0, n < n_avg, n + 1):
            with for_(*from_array(df, dfs)):
                ...
                with for_(*from_array(dc, flux)):
                    ...
                    multiRO_measurement( iqdata_stream, resonators=[x+1 for x in q_id], sequential=False)
