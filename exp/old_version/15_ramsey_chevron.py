...
t_delay = np.arange(1, 500, 4)  # Idle time sweep in clock cycles (Needs to be a list of integers)
...
if simulate:
    ...
    while results.is_processing():
        ...
        plt.title(f"qubit 1 I, fcent={(qubit_LO[0] + qubit_IF[0]) / u.MHz} MHz")
        ...
        plt.title(f"qubit 2 I, fcent={(qubit_LO[1] + qubit_IF[1]) / u.MHz} MHz")
        plt.subplot(246)
        plt.cla()
        ...
        plt.title(f"qubit 3 I, fcent={(qubit_LO[2] + qubit_IF[2]) / u.MHz} MHz")
        plt.subplot(247)
        plt.cla()
        ...
        plt.title(f"qubit 4 I, fcent={(qubit_LO[3] + qubit_IF[3]) / u.MHz} MHz")
        plt.subplot(248)
        plt.cla()
