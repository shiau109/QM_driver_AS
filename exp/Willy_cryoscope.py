...
if simulate:
    ...
    while results.is_processing():
        ...
        # print('!!!!!!!!!!!!'+'phase: ',phase)
        phase = phase - phase[-1]
        # print('AAAAAAAAAAAA'+'phase: ',phase)
...
I_x90 = xr.DataArray(I3[:,0], coords=coords, dims=dims)
I_y90 = xr.DataArray(I3[:,1], coords=coords, dims=dims)
Q_x90 = xr.DataArray(Q3[:,0], coords=coords, dims=dims)
Q_y90 = xr.DataArray(Q3[:,1], coords=coords, dims=dims)
state_Sxx = xr.DataArray(Sxx, coords=coords, dims=dims)
state_Syy = xr.DataArray(Syy, coords=coords, dims=dims)
# state_S = xr.DataArray(S, coords=coords, dims=dims)
...
ds.to_netcdf("test_cryo.nc", engine='netcdf4', format='NETCDF4')