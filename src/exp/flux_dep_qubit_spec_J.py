...
def cw_twotone_qubit( offset_arr, d_freq_arr, q_name:list, ro_element:list, z_name:list, config, qmm:QuantumMachinesManager, n_avg:int=100, saturation_len=1, saturation_ampRatio=0.1, flux_settle_time=10, simulate:bool=False):
    """
    q_name is XY on
    z_name is Z
...
def const_flux_qubit_spec( offset_arr, d_freq_arr, q_name:list, ro_element:list, z_name:list, config, qmm:QuantumMachinesManager, n_avg:int=100, saturation_len=1, saturation_ampRatio=0.1, flux_settle_time=10, simulate:bool=False):
    """
    q_name is XY on
    z_name is Z
