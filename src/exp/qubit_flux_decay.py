...
from exp.common_fitting_func import gaussian
...
if __name__ == '__main__':
    ...
    idle_point=[["q2",-0.3905,4.1576],['q2',-0.2489,3.9966,4.3]]
    sweetspot = [['q2',-0.3473,4.1985,4.3],['q2',4.1985,0.05,40]]
    n_avg = 100
    ...
    dfs = np.arange(-100e6, 100e6, 0.5e6)
    ...
    if save_data == True:
        ...
        save_npz("C:\謝博安\DR3_QM_opt\q2_T1", "q2_t1_raw", output)
