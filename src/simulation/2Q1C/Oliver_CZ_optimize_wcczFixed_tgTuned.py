...
w2_CZ = 4.5 * 2*pi
wc_CZ = 4.77 * 2*pi #[GHz]
########## calculate g_eff at CZw1_CZ_
CZw1_CZ_pre = w2_CZ-EC2
d1c_CZ = CZw1_CZ_pre-wc_CZ
d2c_CZ = w2_CZ-wc_CZ
siga1c_CZ = CZw1_CZ_pre+wc_CZ
siga2c_CZ = w2_CZ+wc_CZ
g12_CZ = g12_max*sqrt(CZw1_CZ_pre*w2_CZ)/sqrt(w1_max*w2_max)
g1c_CZ = g1c_max*sqrt(CZw1_CZ_pre*wc_CZ)/sqrt(w1_max*wc_max)
...
r_cp = 0
w1_CZ0 = CZw1_CZ_pre#(3.94+0.006865) * 2*pi
tr0_c = 5
tr_q = 0.01
tg0 = 1*T_CZ_sudden+2*tr0_c
############################################
...
print('wq1_CZ=', Sol.x[2]/2/pi,'(GHz)')
print('(t_ramp_q,t_ramp_c,t_gate)=', [tr_q,Sol.x[0],Sol.x[1]],'(ns)')
