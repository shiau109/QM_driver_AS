...
filename = r"C:\Users\quant\SynologyDrive\09 Data\Fridge Data\Qubit\20240905_DR3_5Q4C_0430#7\raw_data\20240930_171202_CZ_diff\q3q4_cz_phasediff_shot.nc"
...
for i in range(len(c_amp)):
    for j in range(len(cz_amp)):
        ...
        if abs((abs(g_phi-e_phi)-np.pi))<=0.3:
