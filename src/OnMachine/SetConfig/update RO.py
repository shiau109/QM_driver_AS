...
ro_infos = [
{
        "name":"q0",
        "IF": -161.2+4.71,
        "amp": 0.2 *0.1*2,#*0.3*0.5*4*1.1 *0.8,#*0.65,
        "length":400,
        "phase": 345+11
    },{
        "name":"q1",
        "IF": -58.1+2.3,
        "amp": 0.2 *0.1,#*0.3*0.5*4*0.75 *0.8,
        "length":400,
        "phase": 17-33-7
    },{
        "name":"q2",
        "IF": -213.1+0.28,
        "amp": 0.2 *0.1,#*0.15*2*2*1.1 *0.8,
        "length":400,
        "phase": 291.7+86+10
    },{
        "name":"q3",
        "IF": -34.7+4.2-0.4,
        "amp": 0.2 *0.1*2*1.5*1.3,#*0.3*0.5 *0.8,
        "length":400,
        "phase": 0
    },{
        "name":"q4",
        "IF":-127.4+1-0.5,
        "amp": 0.2 *0.1*1.5*1.8*1.5*1.15*1.2*0.6,#*0.3*0.5 *0.8,
        "length":400,
        "phase": 0
    }
]
