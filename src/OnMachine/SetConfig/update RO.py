...
new_LO = 6.1
rin_offset = (+0.01502-0.00016+7.9e-5,+0.01300+2.5e-5) # I,Q
# rin_offset = (+0,+0) # I,Q
tof = 80
...
{
        "name":"q0",
        "IF": -164-0.3-2-0.1-0.1 -3.55,
        "amp": 0.2,#*0.3*0.5*4*1.1 *0.8,#*0.65,
        "length":2000,
        "phase": 345+11
    },{
        "name":"q1",
        "IF": -62+0.7+0.15-0.3 -3.04,
        "amp": 0.2,#*0.3*0.5*4*0.75 *0.8,
        "length":2000,
        "phase": 17-33-7
    },{
        "name":"q2",
        "IF": -207-1.6-1 -3.60,
        "amp": 0.2,#*0.15*2*2*1.1 *0.8,
        "length":2000,
        "phase": 291.7+86+10
    },{
        "name":"q3",
